...
namespace MovieData.Client.Repositories
{
    public interface IMovieRepository
    {
        ...
        ActorWrapper GetActor(string countryCode);
    ...
    public class MovieRepository : IMovieRepository
    {
        ...
        public ActorWrapper GetActor(string countryCode)
        {
            var client = new RestClient($"http://{AppConfig.Host}:{AppConfig.Port}/api/table/actor/{countryCode}");
            var request = new RestRequest(Method.GET);
            var response = client.Execute(request);
            ...
            if (response.IsSuccessful)
            {
                ...
                return content.ToObject<ActorWrapper>();
            }
